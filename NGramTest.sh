...
#for n in {1..4}
#do
#    python3 NGram.py --N $n --training_file corpus/train_all.pkl --test_file corpus/test_all.pkl --output_file compareN.txt --backoff False
#    python3 NGram.py --N $n --training_file corpus/train_all.pkl --test_file corpus/test_all.pkl --output_file compareN.txt --backoff True
#done
...
do
    for test in corpus/test_all.pkl corpus/test_business.pkl corpus/test_enter.pkl corpus/test_pol.pkl corpus/test_sport.pkl corpus/test_tech.pkl
    do
    python3 NGram.py --N 3 --training_file $train --test_file $test --output_file n3.txt
    done
done